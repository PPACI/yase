...
class test_yast(unittest.TestCase):
    @patch("yase.yase.count_line")
    @patch("yase.yase.get_file_iterator")
    ...
    def test_transcode_str_line_with_replacements(self):
        ...
        dict_repl = yase.get_replacement_dict(path="yase/Ressources/replacement.json", no_replace=False)
    ...
    def test_get_replacement_dict(self):
        with open("yase/Ressources/replacement.json") as f:
        ...
        dict_repl = yase.get_replacement_dict(path="yase/Ressources/replacement.json", no_replace=True)
